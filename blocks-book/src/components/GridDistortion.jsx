...
const GridDistortion = ({
  ...
  useEffect(() => {
    const observerOptions = {
      ...
      rootMargin: '100px' // Add margin to reduce triggering on partial visibility
    };
    
    // Use a more stable approach to handle visibility changes
  ...
  // Set up Three.js scene and animation
  useEffect(() => {
  ...
  }, [grid, mouse, strength, relaxation, imageSrc, isVisible]);
